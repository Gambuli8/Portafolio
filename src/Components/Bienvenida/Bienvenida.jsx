                ...
                <div className='inicio'>
                    ...
                    <div className='containerSobremi'>
                        ...
                        <div className='parrafoSobremi'>
                            <p>
                                {' '}
                                Soy <span style={{ color: '#646cff' }}>Desarrollador Full Stack</span> apasionado por crear soluciones web. Con experiencia en tecnologías front-end y back-end, me encanta convertir ideas en código funcional. Si buscas
                                un colaborador apasionado para tu proyecto, ¡estoy listo para ayudar! <span className='spanContact'>Contactame!</span>.
                            </p>
                        </div>
                    </div>
                    <div className='redes'>
